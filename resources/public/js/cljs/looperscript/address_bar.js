...
cljs.looperscript.address_bar.text__GT_link = (function text__GT_link(){var text = escape(btoa(editor.getValue()));return cljs.looperscript.address_bar.put_text_in_get.call(null,("?loop="+cljs.core.str.cljs$core$IFn$_invoke$arity$1(text)));
});
...
cljs.looperscript.address_bar.set_loop_text = (function set_loop_text(s){return editor.setValue(s);
});
