...
var range_STAR___3 = (function (a,b,c){return cljs.core.range.call(null,a,(b + c),c);
});
...
var rand_weighted__delegate = function (v){var vec__32929 = cljs.core.apply.call(null,cljs.core.map,cljs.core.vector,cljs.core.partition.call(null,(2),v));var vs = cljs.core.nth.call(null,vec__32929,(0),null);var ws = cljs.core.nth.call(null,vec__32929,(1),null);var cum_ws = cljs.core.reductions.call(null,cljs.core._PLUS_,(0),ws);var sum = cljs.core.last.call(null,cum_ws);var r = (cljs.core.rand.call(null) * sum);return cljs.core.some.call(null,((function (vec__32929,vs,ws,cum_ws,sum,r){
return (function (p1__32927_SHARP_){if((cljs.core.nth.call(null,cum_ws,p1__32927_SHARP_) < r))
{return cljs.core.nth.call(null,vs,p1__32927_SHARP_);
} else
{return null;
}
});})(vec__32929,vs,ws,cum_ws,sum,r))
...
return (function (p1__32931_SHARP_){return cljs.core._EQ_.call(null,cljs.core.deref.call(null,current_choice),p1__32931_SHARP_);
});})(current_choice))
,options))));
}
});
...
cljs.looperscript.vector_fns.rand_walk2 = (function rand_walk2(intervals,v){var rand_int_range = (function (a,b){return (a + cljs.core.rand_int.call(null,((b - a) + (1))));
});var max_v = (cljs.core.count.call(null,v) - (1));var pos = cljs.core.atom.call(null,cljs.core.rand_int.call(null,cljs.core.count.call(null,v)));return ((function (rand_int_range,max_v,pos){
return (function (){return cljs.core.nth.call(null,v,cljs.core.reset_BANG_.call(null,pos,(function (){while(true){
var new_pos = cljs.core.rand_nth.call(null,cljs.core.filter.call(null,((function (rand_int_range,max_v,pos){
return (function (p1__32933_SHARP_){return (((0) <= p1__32933_SHARP_)) && ((p1__32933_SHARP_ <= max_v));
});})(rand_int_range,max_v,pos))
,cljs.core.map.call(null,((function (rand_int_range,max_v,pos){
return (function (p1__32932_SHARP_){return (p1__32932_SHARP_ + cljs.core.deref.call(null,pos));
});})(rand_int_range,max_v,pos))
,intervals)));if(cljs.core._EQ_.call(null,new_pos,cljs.core.deref.call(null,pos)))
{{
continue;
}
} else
...
cljs.looperscript.vector_fns.in$ = (function in$(t,v){var v__$1 = cljs.core.flatten.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [v], null));var factor = (t / cljs.core.reduce.call(null,cljs.core._PLUS_,v__$1));return cljs.core.map.call(null,((function (v__$1,factor){
return (function (p1__32934_SHARP_){return (factor * p1__32934_SHARP_);
});})(v__$1,factor))
,v__$1);
});
...
return (function (p1__32935_SHARP_){return cljs.core.mod.call(null,(p1__32935_SHARP_ + (1)),v_len);
});})(pos,v_len))
));
});
;})(pos,v_len))
...
return (function (p1__32936_SHARP_){cljs.core.reset_BANG_.call(null,previous_total,cljs.core.deref.call(null,total));
...
cljs.looperscript.vector_fns.scale_pattern = (function scale_pattern(scale,pattern,degrees){var iter__4379__auto__ = (function iter__32944(s__32945){return (new cljs.core.LazySeq(null,(function (){var s__32945__$1 = s__32945;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__32945__$1);if(temp__4126__auto__)
{var xs__4624__auto__ = temp__4126__auto__;var d = cljs.core.first.call(null,xs__4624__auto__);var iterys__4375__auto__ = ((function (s__32945__$1,d,xs__4624__auto__,temp__4126__auto__){
return (function iter__32946(s__32947){return (new cljs.core.LazySeq(null,((function (s__32945__$1,d,xs__4624__auto__,temp__4126__auto__){
return (function (){var s__32947__$1 = s__32947;while(true){
var temp__4126__auto____$1 = cljs.core.seq.call(null,s__32947__$1);if(temp__4126__auto____$1)
{var s__32947__$2 = temp__4126__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,s__32947__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__32947__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__32949 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__32948 = (0);while(true){
if((i__32948 < size__4378__auto__))
{var p = cljs.core._nth.call(null,c__4377__auto__,i__32948);cljs.core.chunk_append.call(null,b__32949,cljs.looperscript.vector_fns.scale_nth.call(null,scale,(d + p)));
{
...
{var p = cljs.core.first.call(null,s__32947__$2);return cljs.core.cons.call(null,cljs.looperscript.vector_fns.scale_nth.call(null,scale,(d + p)),iter__32946.call(null,cljs.core.rest.call(null,s__32947__$2)));
}
} else
{return null;
}
...
cljs.looperscript.vector_fns.transpose_scale = (function transpose_scale(degree,scale){return cljs.core.sort.call(null,cljs.core.map.call(null,(function (p1__32952_SHARP_){return cljs.core.mod.call(null,(p1__32952_SHARP_ + degree),(12));
}),scale));
});
...
return (function (p1__32953_SHARP_){return ((floor <= p1__32953_SHARP_)) && ((p1__32953_SHARP_ <= ceil));
});})(a,b))
,(function (){var iter__4379__auto__ = ((function (a,b){
return (function iter__32960(s__32961){return (new cljs.core.LazySeq(null,((function (a,b){
return (function (){var s__32961__$1 = s__32961;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__32961__$1);if(temp__4126__auto__)
{var xs__4624__auto__ = temp__4126__auto__;var o = cljs.core.first.call(null,xs__4624__auto__);var iterys__4375__auto__ = ((function (s__32961__$1,o,xs__4624__auto__,temp__4126__auto__,a,b){
return (function iter__32962(s__32963){return (new cljs.core.LazySeq(null,((function (s__32961__$1,o,xs__4624__auto__,temp__4126__auto__,a,b){
return (function (){var s__32963__$1 = s__32963;while(true){
var temp__4126__auto____$1 = cljs.core.seq.call(null,s__32963__$1);if(temp__4126__auto____$1)
{var s__32963__$2 = temp__4126__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,s__32963__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__32963__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__32965 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__32964 = (0);while(true){
if((i__32964 < size__4378__auto__))
{var s = cljs.core._nth.call(null,c__4377__auto__,i__32964);cljs.core.chunk_append.call(null,b__32965,(((12) * o) + s));
{
...
{var s = cljs.core.first.call(null,s__32963__$2);return cljs.core.cons.call(null,(((12) * o) + s),iter__32962.call(null,cljs.core.rest.call(null,s__32963__$2)));
}
} else
{return null;
}
...
cljs.looperscript.vector_fns.say = (function say(x){(window["speechSynthesis"]).speak((new SpeechSynthesisUtterance(x)));
return x;
});
...
cljs.looperscript.vector_fns.time = (function time(){return (cljs.looperscript.start_time.now.call(null) - cljs.looperscript.start_time.get_current_start_time.call(null));
});
/**
* @param {...*} var_args
*/
...
cljs.looperscript.vector_fns.cache = (function cache(f){var output = cljs.core.atom.call(null,cljs.core.PersistentVector.EMPTY);var output_pos = cljs.core.atom.call(null,(0));var key_positions = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);return ((function (output,output_pos,key_positions){
return (function (key){if(!(cljs.core.contains_QMARK_.call(null,cljs.core.deref.call(null,key_positions),key)))
{cljs.core.swap_BANG_.call(null,key_positions,cljs.core.assoc,key,(0));
} else
{}
var key_pos = cljs.core.get.call(null,cljs.core.deref.call(null,key_positions),key);if(cljs.core._EQ_.call(null,key_pos,cljs.core.deref.call(null,output_pos)))
{cljs.core.swap_BANG_.call(null,output,cljs.core.conj,f.call(null));
cljs.core.swap_BANG_.call(null,output_pos,cljs.core.inc);
} else
{}
var res = cljs.core.nth.call(null,cljs.core.deref.call(null,output),key_pos);cljs.core.swap_BANG_.call(null,key_positions,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [key], null),cljs.core.inc);
return res;
});
...
var set_rand_seed__delegate = function (args){if(cljs.core.empty_QMARK_.call(null,args))
{Math.seedrandom();
} else
...
var plus__delegate = function (args){return cljs.core.apply.call(null,cljs.core._PLUS_,args);
};
...
var sum__delegate = function (args){return cljs.core.apply.call(null,cljs.core._PLUS_,cljs.core.flatten.call(null,args));
};
...
var times__delegate = function (args){return cljs.core.apply.call(null,cljs.core._STAR_,args);
};
