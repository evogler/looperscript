...
log.cljs$lang$applyTo = (function (arglist__21453){
var args = cljs.core.seq(arglist__21453);
...
var rand_weighted__delegate = function (v){var vec__21456 = cljs.core.apply.call(null,cljs.core.map,cljs.core.vector,cljs.core.partition.call(null,(2),v));var vs = cljs.core.nth.call(null,vec__21456,(0),null);var ws = cljs.core.nth.call(null,vec__21456,(1),null);var cum_ws = cljs.core.reductions.call(null,cljs.core._PLUS_,(0),ws);var sum = cljs.core.last.call(null,cum_ws);var r = (cljs.core.rand.call(null) * sum);return cljs.core.some.call(null,((function (vec__21456,vs,ws,cum_ws,sum,r){
return (function (p1__21454_SHARP_){if((cljs.core.nth.call(null,cum_ws,p1__21454_SHARP_) < r))
{return cljs.core.nth.call(null,vs,p1__21454_SHARP_);
} else
{return null;
}
});})(vec__21456,vs,ws,cum_ws,sum,r))
...
rand_weighted.cljs$lang$applyTo = (function (arglist__21457){
var v = cljs.core.seq(arglist__21457);
...
return (function (p1__21458_SHARP_){return cljs.core._EQ_.call(null,cljs.core.deref.call(null,current_choice),p1__21458_SHARP_);
});})(current_choice))
,options))));
}
});
...
return (function (p1__21459_SHARP_){return (factor * p1__21459_SHARP_);
});})(factor))
,v);
});
...
return (function (p1__21460_SHARP_){return cljs.core.mod.call(null,(p1__21460_SHARP_ + (1)),v_len);
});})(pos,v_len))
));
});
;})(pos,v_len))
...
flatten_STAR_.cljs$lang$applyTo = (function (arglist__21461){
...
cljs.looperscript.vector_fns.scale_pattern = (function scale_pattern(scale,pattern,degrees){var iter__4379__auto__ = (function iter__21468(s__21469){return (new cljs.core.LazySeq(null,(function (){var s__21469__$1 = s__21469;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__21469__$1);if(temp__4126__auto__)
{var xs__4624__auto__ = temp__4126__auto__;var d = cljs.core.first.call(null,xs__4624__auto__);var iterys__4375__auto__ = ((function (s__21469__$1,d,xs__4624__auto__,temp__4126__auto__){
return (function iter__21470(s__21471){return (new cljs.core.LazySeq(null,((function (s__21469__$1,d,xs__4624__auto__,temp__4126__auto__){
return (function (){var s__21471__$1 = s__21471;while(true){
var temp__4126__auto____$1 = cljs.core.seq.call(null,s__21471__$1);if(temp__4126__auto____$1)
{var s__21471__$2 = temp__4126__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,s__21471__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__21471__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__21473 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__21472 = (0);while(true){
if((i__21472 < size__4378__auto__))
{var p = cljs.core._nth.call(null,c__4377__auto__,i__21472);cljs.core.chunk_append.call(null,b__21473,cljs.looperscript.vector_fns.scale_nth.call(null,scale,(d + p)));
{
var G__21474 = (i__21472 + (1));
i__21472 = G__21474;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21473),iter__21470.call(null,cljs.core.chunk_rest.call(null,s__21471__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21473),null);
}
} else
{var p = cljs.core.first.call(null,s__21471__$2);return cljs.core.cons.call(null,cljs.looperscript.vector_fns.scale_nth.call(null,scale,(d + p)),iter__21470.call(null,cljs.core.rest.call(null,s__21471__$2)));
}
} else
{return null;
}
...
});})(s__21469__$1,d,xs__4624__auto__,temp__4126__auto__))
,null,null));
});})(s__21469__$1,d,xs__4624__auto__,temp__4126__auto__))
;var fs__4376__auto__ = cljs.core.seq.call(null,iterys__4375__auto__.call(null,pattern));if(fs__4376__auto__)
{return cljs.core.concat.call(null,fs__4376__auto__,iter__21468.call(null,cljs.core.rest.call(null,s__21469__$1)));
} else
{{
var G__21475 = cljs.core.rest.call(null,s__21469__$1);
s__21469__$1 = G__21475;
continue;
}
}
} else
...
cljs.looperscript.vector_fns.transpose_scale = (function transpose_scale(degree,scale){return cljs.core.sort.call(null,cljs.core.map.call(null,(function (p1__21476_SHARP_){return cljs.core.mod.call(null,(p1__21476_SHARP_ + degree),(12));
}),scale));
});
...
return (function (p1__21477_SHARP_){return ((floor <= p1__21477_SHARP_)) && ((p1__21477_SHARP_ <= ceil));
});})(a,b))
,(function (){var iter__4379__auto__ = ((function (a,b){
return (function iter__21484(s__21485){return (new cljs.core.LazySeq(null,((function (a,b){
return (function (){var s__21485__$1 = s__21485;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__21485__$1);if(temp__4126__auto__)
{var xs__4624__auto__ = temp__4126__auto__;var o = cljs.core.first.call(null,xs__4624__auto__);var iterys__4375__auto__ = ((function (s__21485__$1,o,xs__4624__auto__,temp__4126__auto__,a,b){
return (function iter__21486(s__21487){return (new cljs.core.LazySeq(null,((function (s__21485__$1,o,xs__4624__auto__,temp__4126__auto__,a,b){
return (function (){var s__21487__$1 = s__21487;while(true){
var temp__4126__auto____$1 = cljs.core.seq.call(null,s__21487__$1);if(temp__4126__auto____$1)
{var s__21487__$2 = temp__4126__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,s__21487__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__21487__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__21489 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__21488 = (0);while(true){
if((i__21488 < size__4378__auto__))
{var s = cljs.core._nth.call(null,c__4377__auto__,i__21488);cljs.core.chunk_append.call(null,b__21489,(((12) * o) + s));
{
var G__21490 = (i__21488 + (1));
i__21488 = G__21490;
continue;
}
} else
...
{var s = cljs.core.first.call(null,s__21487__$2);return cljs.core.cons.call(null,(((12) * o) + s),iter__21486.call(null,cljs.core.rest.call(null,s__21487__$2)));
}
} else
{return null;
}
...
});})(s__21485__$1,o,xs__4624__auto__,temp__4126__auto__,a,b))
,null,null));
});})(s__21485__$1,o,xs__4624__auto__,temp__4126__auto__,a,b))
;var fs__4376__auto__ = cljs.core.seq.call(null,iterys__4375__auto__.call(null,scale));if(fs__4376__auto__)
{return cljs.core.concat.call(null,fs__4376__auto__,iter__21484.call(null,cljs.core.rest.call(null,s__21485__$1)));
} else
{{
var G__21491 = cljs.core.rest.call(null,s__21485__$1);
s__21485__$1 = G__21491;
continue;
}
}
} else
...
over_mod.cljs$lang$applyTo = (function (arglist__21492){
var layers = cljs.core.seq(arglist__21492);
...
add_dethunk_test.cljs$lang$applyTo = (function (arglist__21493){
