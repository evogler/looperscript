...
var G__32173 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__32173,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__32173;
}
});
...
var or__27709__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__28878__auto___32178 = arguments.length;
var i__28879__auto___32179 = (0);
while(true){
if((i__28879__auto___32179 < len__28878__auto___32178)){
args__28885__auto__.push((arguments[i__28879__auto___32179]));

var G__32180 = (i__28879__auto___32179 + (1));
i__28879__auto___32179 = G__32180;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28886__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq32175){
var G__32176 = cljs.core.first.call(null,seq32175);
var seq32175__$1 = cljs.core.next.call(null,seq32175);
var G__32177 = cljs.core.first.call(null,seq32175__$1);
var seq32175__$2 = cljs.core.next.call(null,seq32175__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__32176,G__32177,seq32175__$2);
});
...
var line = cljs.core.get.call(null,map__32182__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__32182__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__32182,map__32182__$1,file,line,column){
return (function (p1__32181_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__32181_SHARP_));
});})(map__32182,map__32182__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__28664__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__28664__auto__,prefer_table__28665__auto__,method_cache__28666__auto__,cached_hierarchy__28667__auto__,hierarchy__28668__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__27709__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__27709__auto__)){
return or__27709__auto__;
} else {
...
var temp__4657__auto___32184 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___32184)){
var message_32185 = temp__4657__auto___32184;
cljs.core.println.call(null,message_32185);
} else {
}
...
var temp__4657__auto___32186 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___32186)){
var message_32187 = temp__4657__auto___32186;
cljs.core.println.call(null,message_32187);
} else {
}
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32188),"/"].join('');
} else {
return G__32188;
}
})();
...
var temp__4655__auto__ = (function (){var and__27697__auto__ = typeof exception.stack === 'string';
if(and__27697__auto__){
var G__32190 = exception.stack;
var G__32190__$1 = (((G__32190 == null))?null:clojure.string.split_lines.call(null,G__32190));
var G__32190__$2 = (((G__32190__$1 == null))?null:cljs.core.get.call(null,G__32190__$1,depth));
if((G__32190__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__32190__$2);
}
} else {
...
var vec__32191 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__32191,(0),null);
var column = cljs.core.nth.call(null,vec__32191,(1),null);
var vec__32194 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__32194,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__32194,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__32194,(2),null);
...
var G__32201 = (function (){var G__32200 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__32200);
} else {
return G__32200;
}
})();
...
return cljs.core.vary_meta.call(null,G__32202,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__32206 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__32206,(0),null);
...
return cljs.core.map.call(null,(function (p__32209){
var vec__32210 = p__32209;
var ns = cljs.core.nth.call(null,vec__32210,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__32210,(1),null);
return ((function (vec__32210,ns,vars__$1){
return (function (){
...
var G__32213 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__32213,G__32213__$1,env,once_fixtures,each_fixtures,vec__32210,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__32213,G__32213__$1,env,once_fixtures,each_fixtures,vec__32210,ns,vars__$1){
return (function (){
var seq__32214 = cljs.core.seq.call(null,vars__$1);
var chunk__32215 = null;
var count__32216 = (0);
var i__32217 = (0);
while(true){
if((i__32217 < count__32216)){
var v = cljs.core._nth.call(null,chunk__32215,i__32217);
var temp__4657__auto___32219 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___32219)){
var t_32220 = temp__4657__auto___32219;
each_fixture_fn.call(null,((function (seq__32214,chunk__32215,count__32216,i__32217,t_32220,temp__4657__auto___32219,v,each_fixture_fn,G__32213,G__32213__$1,env,once_fixtures,each_fixtures,vec__32210,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_32220)));
});})(seq__32214,chunk__32215,count__32216,i__32217,t_32220,temp__4657__auto___32219,v,each_fixture_fn,G__32213,G__32213__$1,env,once_fixtures,each_fixtures,vec__32210,ns,vars__$1))
);
} else {
}

var G__32221 = seq__32214;
var G__32222 = chunk__32215;
var G__32223 = count__32216;
var G__32224 = (i__32217 + (1));
seq__32214 = G__32221;
chunk__32215 = G__32222;
count__32216 = G__32223;
i__32217 = G__32224;
continue;
} else {
...
var c__28548__auto__ = cljs.core.chunk_first.call(null,seq__32214__$1);
var G__32225 = cljs.core.chunk_rest.call(null,seq__32214__$1);
var G__32226 = c__28548__auto__;
var G__32227 = cljs.core.count.call(null,c__28548__auto__);
var G__32228 = (0);
seq__32214 = G__32225;
chunk__32215 = G__32226;
count__32216 = G__32227;
i__32217 = G__32228;
continue;
} else {
var v = cljs.core.first.call(null,seq__32214__$1);
var temp__4657__auto___32229__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___32229__$1)){
var t_32230 = temp__4657__auto___32229__$1;
each_fixture_fn.call(null,((function (seq__32214,chunk__32215,count__32216,i__32217,t_32230,temp__4657__auto___32229__$1,v,seq__32214__$1,temp__4657__auto__,each_fixture_fn,G__32213,G__32213__$1,env,once_fixtures,each_fixtures,vec__32210,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_32230)));
});})(seq__32214,chunk__32215,count__32216,i__32217,t_32230,temp__4657__auto___32229__$1,v,seq__32214__$1,temp__4657__auto__,each_fixture_fn,G__32213,G__32213__$1,env,once_fixtures,each_fixtures,vec__32210,ns,vars__$1))
);
} else {
}

var G__32231 = cljs.core.next.call(null,seq__32214__$1);
var G__32232 = null;
var G__32233 = (0);
var G__32234 = (0);
seq__32214 = G__32231;
chunk__32215 = G__32232;
count__32216 = G__32233;
i__32217 = G__32234;
continue;
}
} else {
...
});})(each_fixture_fn,G__32213,G__32213__$1,env,once_fixtures,each_fixtures,vec__32210,ns,vars__$1))
);
});})(each_fixture_fn,G__32213,G__32213__$1,env,once_fixtures,each_fixtures,vec__32210,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32213__$1)].join('')));

}
})());
});
;})(vec__32210,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1512000282678
