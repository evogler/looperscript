...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14664 = (0);while(true){
var m_14665 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14665 == null))
{} else
{m_14665.call(null);
if((count_14664 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14666 = (count_14664 + (1));
count_14664 = G__14666;
continue;
}
} else
{}
