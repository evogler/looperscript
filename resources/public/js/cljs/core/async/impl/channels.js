...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14670 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14670 = (function (val,box,meta14671){
this.val = val;
this.box = box;
this.meta14671 = meta14671;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t14670.cljs$lang$type = true;
cljs.core.async.impl.channels.t14670.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14670";
cljs.core.async.impl.channels.t14670.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write.call(null,writer__4218__auto__,"cljs.core.async.impl.channels/t14670");
});
cljs.core.async.impl.channels.t14670.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14670.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14672){var self__ = this;
var _14672__$1 = this;return self__.meta14671;
});
cljs.core.async.impl.channels.t14670.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14672,meta14671__$1){var self__ = this;
var _14672__$1 = this;return (new cljs.core.async.impl.channels.t14670(self__.val,self__.box,meta14671__$1));
});
cljs.core.async.impl.channels.__GT_t14670 = (function __GT_t14670(val__$1,box__$1,meta14671){return (new cljs.core.async.impl.channels.t14670(val__$1,box__$1,meta14671));
});
}
return (new cljs.core.async.impl.channels.t14670(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14673 = self__.takes.pop();if((taker_14673 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14673))
{var take_cb_14674 = cljs.core.async.impl.protocols.commit.call(null,taker_14673);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14674,taker_14673,this$__$1){
return (function (){return take_cb_14674.call(null,null);
});})(take_cb_14674,taker_14673,this$__$1))
);
} else
{}
{
