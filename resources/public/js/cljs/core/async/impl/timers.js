...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14571 = (0);while(true){
if((i_14571 < arr.length))
{(arr[i_14571] = null);
{
...
{var i_14578 = (self__.level + (1));while(true){
if((i_14578 <= (new_level + (1))))
{(update[i_14578] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14580 = (0);while(true){
if((i_14580 <= self__.level))
{var links_14581 = (update[i_14580]).forward;if(((links_14581[i_14580]) === x__$1))
{(links_14581[i_14580] = (x__$1.forward[i_14580]));
{
var G__14582 = (i_14580 + (1));
i_14580 = G__14582;
continue;
}
} else
{{
var G__14583 = (i_14580 + (1));
i_14580 = G__14583;
continue;
}
}
