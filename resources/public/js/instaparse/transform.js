...
*/
instaparse.transform.merge_meta = (function merge_meta(obj,metamap){if((function (){var G__48627 = obj;if(G__48627)
{var bit__4304__auto__ = (G__48627.cljs$lang$protocol_mask$partition0$ & (262144));if((bit__4304__auto__) || (G__48627.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__48627.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__48627);
} else
{return false;
}
}
