...
var G__21528__delegate = function (num1,num2,nums){var v = cljs.core.vec.call(null,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [num1,num2], null),nums));if(cljs.core._EQ_.call(null,v.call(null,(1)),"-"))
...
return (function iter__21524(s__21525){return (new cljs.core.LazySeq(null,((function (v){
return (function (){var s__21525__$1 = s__21525;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__21525__$1);if(temp__4126__auto__)
{var s__21525__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__21525__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__21525__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__21527 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__21526 = (0);while(true){
if((i__21526 < size__4378__auto__))
{var n = cljs.core._nth.call(null,c__4377__auto__,i__21526);cljs.core.chunk_append.call(null,b__21527,instaparse.combinators_source.string.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.char$.call(null,n)))));
{
var G__21529 = (i__21526 + (1));
i__21526 = G__21529;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21527),iter__21524.call(null,cljs.core.chunk_rest.call(null,s__21525__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21527),null);
}
} else
{var n = cljs.core.first.call(null,s__21525__$2);return cljs.core.cons.call(null,instaparse.combinators_source.string.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.char$.call(null,n)))),iter__21524.call(null,cljs.core.rest.call(null,s__21525__$2)));
}
} else
{return null;
}
...
var G__21528 = function (num1,num2,var_args){
var nums = null;if (arguments.length > 2) {
  nums = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__21528__delegate.call(this,num1,num2,nums);};
G__21528.cljs$lang$maxFixedArity = 2;
G__21528.cljs$lang$applyTo = (function (arglist__21530){
var num1 = cljs.core.first(arglist__21530);
arglist__21530 = cljs.core.next(arglist__21530);
var num2 = cljs.core.first(arglist__21530);
var nums = cljs.core.rest(arglist__21530);
return G__21528__delegate(num1,num2,nums);
});
...
*/
instaparse.abnf.project = (function project(m,ks){return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4379__auto__ = (function iter__21535(s__21536){return (new cljs.core.LazySeq(null,(function (){var s__21536__$1 = s__21536;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__21536__$1);if(temp__4126__auto__)
{var s__21536__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__21536__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__21536__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__21538 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__21537 = (0);while(true){
if((i__21537 < size__4378__auto__))
{var k = cljs.core._nth.call(null,c__4377__auto__,i__21537);if(cljs.core.contains_QMARK_.call(null,m,k))
{cljs.core.chunk_append.call(null,b__21538,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,m.call(null,k)], null));
{
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21538),iter__21535.call(null,cljs.core.chunk_rest.call(null,s__21536__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21538),null);
}
} else
{var k = cljs.core.first.call(null,s__21536__$2);if(cljs.core.contains_QMARK_.call(null,m,k))
{return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,m.call(null,k)], null),iter__21535.call(null,cljs.core.rest.call(null,s__21536__$2)));
} else
{{
var G__21541 = cljs.core.rest.call(null,s__21536__$2);
s__21536__$1 = G__21541;
continue;
}
}
}
...
var G__21546__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs),(2));
};
...
return G__21546__delegate.call(this,cs);};
G__21546.cljs$lang$maxFixedArity = 0;
G__21546.cljs$lang$applyTo = (function (arglist__21547){
var cs = cljs.core.seq(arglist__21547);
return G__21546__delegate(cs);
});
G__21546.cljs$core$IFn$_invoke$arity$variadic = G__21546__delegate;
return G__21546;
})()
,cljs.core.hash_map,(function() { 
var G__21548__delegate = function (rest__21543_SHARP_){if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_))
{return instaparse.combinators_source.nt.call(null,cljs.core.keyword.call(null,clojure.string.upper_case.call(null,cljs.core.apply.call(null,cljs.core.str,rest__21543_SHARP_))));
} else
{return instaparse.combinators_source.nt.call(null,cljs.core.keyword.call(null,cljs.core.apply.call(null,cljs.core.str,rest__21543_SHARP_)));
}
};
var G__21548 = function (var_args){
var rest__21543_SHARP_ = null;if (arguments.length > 0) {
  rest__21543_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__21548__delegate.call(this,rest__21543_SHARP_);};
G__21548.cljs$lang$maxFixedArity = 0;
G__21548.cljs$lang$applyTo = (function (arglist__21549){
var rest__21543_SHARP_ = cljs.core.seq(arglist__21549);
return G__21548__delegate(rest__21543_SHARP_);
});
G__21548.cljs$core$IFn$_invoke$arity$variadic = G__21548__delegate;
return G__21548;
})()
,(function() { 
var G__21550__delegate = function (rest__21544_SHARP_){return parseInt(cljs.core.apply.call(null,cljs.core.str,rest__21544_SHARP_));
};
var G__21550 = function (var_args){
var rest__21544_SHARP_ = null;if (arguments.length > 0) {
  rest__21544_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__21550__delegate.call(this,rest__21544_SHARP_);};
G__21550.cljs$lang$maxFixedArity = 0;
G__21550.cljs$lang$applyTo = (function (arglist__21551){
var rest__21544_SHARP_ = cljs.core.seq(arglist__21551);
return G__21550__delegate(rest__21544_SHARP_);
});
G__21550.cljs$core$IFn$_invoke$arity$variadic = G__21550__delegate;
return G__21550;
})()
,(function() { 
var G__21552__delegate = function (cs){return instaparse.combinators_source.string_ci.call(null,cljs.core.apply.call(null,cljs.core.str,cs));
};
var G__21552 = function (var_args){
var cs = null;if (arguments.length > 0) {
  cs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__21552__delegate.call(this,cs);};
G__21552.cljs$lang$maxFixedArity = 0;
G__21552.cljs$lang$applyTo = (function (arglist__21553){
var cs = cljs.core.seq(arglist__21553);
return G__21552__delegate(cs);
});
...
var G__21554__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs),(16));
};
var G__21554 = function (var_args){
var cs = null;if (arguments.length > 0) {
  cs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__21554__delegate.call(this,cs);};
G__21554.cljs$lang$maxFixedArity = 0;
G__21554.cljs$lang$applyTo = (function (arglist__21555){
var cs = cljs.core.seq(arglist__21555);
return G__21554__delegate(cs);
});
...
var G__21556 = null;
var G__21556__1 = (function (element){return element;
});
var G__21556__2 = (function (repeat,element){if(cljs.core.empty_QMARK_.call(null,repeat))
...
G__21556 = function(repeat,element){
switch(arguments.length){
case 1:
return G__21556__1.call(this,repeat);
case 2:
return G__21556__2.call(this,repeat,element);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__21556.cljs$core$IFn$_invoke$arity$1 = G__21556__1;
G__21556.cljs$core$IFn$_invoke$arity$2 = G__21556__2;
return G__21556;
})()
,(function() { 
var G__21557__delegate = function (rest__21542_SHARP_){if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_))
{return cljs.core.keyword.call(null,clojure.string.upper_case.call(null,cljs.core.apply.call(null,cljs.core.str,rest__21542_SHARP_)));
} else
{return cljs.core.keyword.call(null,cljs.core.apply.call(null,cljs.core.str,rest__21542_SHARP_));
}
};
var G__21557 = function (var_args){
var rest__21542_SHARP_ = null;if (arguments.length > 0) {
  rest__21542_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__21557__delegate.call(this,rest__21542_SHARP_);};
G__21557.cljs$lang$maxFixedArity = 0;
G__21557.cljs$lang$applyTo = (function (arglist__21558){
var rest__21542_SHARP_ = cljs.core.seq(arglist__21558);
return G__21557__delegate(rest__21542_SHARP_);
});
G__21557.cljs$core$IFn$_invoke$arity$variadic = G__21557__delegate;
return G__21557;
})()
,(function() { 
var G__21559__delegate = function (items){var G__21545 = cljs.core.count.call(null,items);switch (G__21545) {
case (1):
...
return G__21559__delegate.call(this,items);};
G__21559.cljs$lang$maxFixedArity = 0;
G__21559.cljs$lang$applyTo = (function (arglist__21561){
var items = cljs.core.seq(arglist__21561);
return G__21559__delegate(items);
});
G__21559.cljs$core$IFn$_invoke$arity$variadic = G__21559__delegate;
return G__21559;
})()
,instaparse.abnf.get_char_combinator,(function() { 
var G__21562__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs));
};
...
var cs = cljs.core.seq(arglist__21563);
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_21566_21568 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_21566_21568,sb__4581__auto__,rule_tree){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_21566_21568,sb__4581__auto__,rule_tree))
;
cljs.core.println.call(null,rule_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_21566_21568;
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_21567_21569 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_21567_21569,sb__4581__auto__,rhs_tree){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_21567_21569,sb__4581__auto__,rhs_tree))
;
cljs.core.println.call(null,rhs_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_21567_21569;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4581__auto__));
})()));
} else
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_21571_21572 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_21571_21572,sb__4581__auto__,rule_tree){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_21571_21572,sb__4581__auto__,rule_tree))
;
cljs.core.println.call(null,rule_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_21571_21572;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4581__auto__));
})()));
} else
