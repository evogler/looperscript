...
var G__48516__delegate = function (num1,num2,nums){var v = cljs.core.vec.call(null,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [num1,num2], null),nums));if(cljs.core._EQ_.call(null,v.call(null,(1)),"-"))
...
return (function iter__48512(s__48513){return (new cljs.core.LazySeq(null,((function (v){
return (function (){var s__48513__$1 = s__48513;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__48513__$1);if(temp__4126__auto__)
{var s__48513__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__48513__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__48513__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__48515 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__48514 = (0);while(true){
if((i__48514 < size__4378__auto__))
{var n = cljs.core._nth.call(null,c__4377__auto__,i__48514);cljs.core.chunk_append.call(null,b__48515,instaparse.combinators_source.string.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.char$.call(null,n)))));
{
var G__48517 = (i__48514 + (1));
i__48514 = G__48517;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__48515),iter__48512.call(null,cljs.core.chunk_rest.call(null,s__48513__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__48515),null);
}
} else
{var n = cljs.core.first.call(null,s__48513__$2);return cljs.core.cons.call(null,instaparse.combinators_source.string.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.char$.call(null,n)))),iter__48512.call(null,cljs.core.rest.call(null,s__48513__$2)));
}
} else
{return null;
}
...
var G__48516 = function (num1,num2,var_args){
var nums = null;if (arguments.length > 2) {
  nums = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__48516__delegate.call(this,num1,num2,nums);};
G__48516.cljs$lang$maxFixedArity = 2;
G__48516.cljs$lang$applyTo = (function (arglist__48518){
var num1 = cljs.core.first(arglist__48518);
arglist__48518 = cljs.core.next(arglist__48518);
var num2 = cljs.core.first(arglist__48518);
var nums = cljs.core.rest(arglist__48518);
return G__48516__delegate(num1,num2,nums);
});
...
*/
instaparse.abnf.project = (function project(m,ks){return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4379__auto__ = (function iter__48523(s__48524){return (new cljs.core.LazySeq(null,(function (){var s__48524__$1 = s__48524;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__48524__$1);if(temp__4126__auto__)
{var s__48524__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__48524__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__48524__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__48526 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__48525 = (0);while(true){
if((i__48525 < size__4378__auto__))
{var k = cljs.core._nth.call(null,c__4377__auto__,i__48525);if(cljs.core.contains_QMARK_.call(null,m,k))
{cljs.core.chunk_append.call(null,b__48526,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,m.call(null,k)], null));
{
var G__48527 = (i__48525 + (1));
i__48525 = G__48527;
continue;
}
} else
{{
var G__48528 = (i__48525 + (1));
i__48525 = G__48528;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__48526),iter__48523.call(null,cljs.core.chunk_rest.call(null,s__48524__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__48526),null);
}
} else
{var k = cljs.core.first.call(null,s__48524__$2);if(cljs.core.contains_QMARK_.call(null,m,k))
{return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,m.call(null,k)], null),iter__48523.call(null,cljs.core.rest.call(null,s__48524__$2)));
} else
{{
var G__48529 = cljs.core.rest.call(null,s__48524__$2);
s__48524__$1 = G__48529;
continue;
}
}
}
...
var G__48534__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs),(2));
};
var G__48534 = function (var_args){
var cs = null;if (arguments.length > 0) {
  cs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__48534__delegate.call(this,cs);};
G__48534.cljs$lang$maxFixedArity = 0;
G__48534.cljs$lang$applyTo = (function (arglist__48535){
var cs = cljs.core.seq(arglist__48535);
return G__48534__delegate(cs);
});
G__48534.cljs$core$IFn$_invoke$arity$variadic = G__48534__delegate;
return G__48534;
})()
,cljs.core.hash_map,(function() { 
var G__48536__delegate = function (rest__48531_SHARP_){if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_))
{return instaparse.combinators_source.nt.call(null,cljs.core.keyword.call(null,clojure.string.upper_case.call(null,cljs.core.apply.call(null,cljs.core.str,rest__48531_SHARP_))));
} else
{return instaparse.combinators_source.nt.call(null,cljs.core.keyword.call(null,cljs.core.apply.call(null,cljs.core.str,rest__48531_SHARP_)));
}
};
var G__48536 = function (var_args){
var rest__48531_SHARP_ = null;if (arguments.length > 0) {
  rest__48531_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__48536__delegate.call(this,rest__48531_SHARP_);};
G__48536.cljs$lang$maxFixedArity = 0;
G__48536.cljs$lang$applyTo = (function (arglist__48537){
var rest__48531_SHARP_ = cljs.core.seq(arglist__48537);
return G__48536__delegate(rest__48531_SHARP_);
});
G__48536.cljs$core$IFn$_invoke$arity$variadic = G__48536__delegate;
return G__48536;
})()
,(function() { 
var G__48538__delegate = function (rest__48532_SHARP_){return parseInt(cljs.core.apply.call(null,cljs.core.str,rest__48532_SHARP_));
};
var G__48538 = function (var_args){
var rest__48532_SHARP_ = null;if (arguments.length > 0) {
  rest__48532_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__48538__delegate.call(this,rest__48532_SHARP_);};
G__48538.cljs$lang$maxFixedArity = 0;
G__48538.cljs$lang$applyTo = (function (arglist__48539){
var rest__48532_SHARP_ = cljs.core.seq(arglist__48539);
return G__48538__delegate(rest__48532_SHARP_);
});
G__48538.cljs$core$IFn$_invoke$arity$variadic = G__48538__delegate;
return G__48538;
})()
,(function() { 
var G__48540__delegate = function (cs){return instaparse.combinators_source.string_ci.call(null,cljs.core.apply.call(null,cljs.core.str,cs));
};
var G__48540 = function (var_args){
var cs = null;if (arguments.length > 0) {
  cs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__48540__delegate.call(this,cs);};
G__48540.cljs$lang$maxFixedArity = 0;
G__48540.cljs$lang$applyTo = (function (arglist__48541){
var cs = cljs.core.seq(arglist__48541);
return G__48540__delegate(cs);
});
...
var G__48542__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs),(16));
};
var G__48542 = function (var_args){
var cs = null;if (arguments.length > 0) {
  cs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__48542__delegate.call(this,cs);};
G__48542.cljs$lang$maxFixedArity = 0;
G__48542.cljs$lang$applyTo = (function (arglist__48543){
var cs = cljs.core.seq(arglist__48543);
return G__48542__delegate(cs);
});
...
var G__48544 = null;
var G__48544__1 = (function (element){return element;
});
var G__48544__2 = (function (repeat,element){if(cljs.core.empty_QMARK_.call(null,repeat))
...
G__48544 = function(repeat,element){
switch(arguments.length){
case 1:
return G__48544__1.call(this,repeat);
case 2:
return G__48544__2.call(this,repeat,element);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__48544.cljs$core$IFn$_invoke$arity$1 = G__48544__1;
G__48544.cljs$core$IFn$_invoke$arity$2 = G__48544__2;
return G__48544;
})()
,(function() { 
var G__48545__delegate = function (rest__48530_SHARP_){if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_))
{return cljs.core.keyword.call(null,clojure.string.upper_case.call(null,cljs.core.apply.call(null,cljs.core.str,rest__48530_SHARP_)));
} else
{return cljs.core.keyword.call(null,cljs.core.apply.call(null,cljs.core.str,rest__48530_SHARP_));
}
};
var G__48545 = function (var_args){
var rest__48530_SHARP_ = null;if (arguments.length > 0) {
  rest__48530_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__48545__delegate.call(this,rest__48530_SHARP_);};
G__48545.cljs$lang$maxFixedArity = 0;
G__48545.cljs$lang$applyTo = (function (arglist__48546){
var rest__48530_SHARP_ = cljs.core.seq(arglist__48546);
return G__48545__delegate(rest__48530_SHARP_);
});
G__48545.cljs$core$IFn$_invoke$arity$variadic = G__48545__delegate;
return G__48545;
})()
,(function() { 
var G__48547__delegate = function (items){var G__48533 = cljs.core.count.call(null,items);switch (G__48533) {
case (1):
...
return G__48547__delegate.call(this,items);};
G__48547.cljs$lang$maxFixedArity = 0;
G__48547.cljs$lang$applyTo = (function (arglist__48549){
var items = cljs.core.seq(arglist__48549);
return G__48547__delegate(items);
});
G__48547.cljs$core$IFn$_invoke$arity$variadic = G__48547__delegate;
return G__48547;
})()
,instaparse.abnf.get_char_combinator,(function() { 
var G__48550__delegate = function (cs){return parseInt(cljs.core.apply.call(null,cljs.core.str,cs));
};
var G__48550 = function (var_args){
var cs = null;if (arguments.length > 0) {
  cs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__48550__delegate.call(this,cs);};
G__48550.cljs$lang$maxFixedArity = 0;
G__48550.cljs$lang$applyTo = (function (arglist__48551){
var cs = cljs.core.seq(arglist__48551);
return G__48550__delegate(cs);
});
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_48554_48556 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_48554_48556,sb__4581__auto__,rule_tree){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_48554_48556,sb__4581__auto__,rule_tree))
;
cljs.core.println.call(null,rule_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_48554_48556;
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_48555_48557 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_48555_48557,sb__4581__auto__,rhs_tree){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_48555_48557,sb__4581__auto__,rhs_tree))
;
cljs.core.println.call(null,rhs_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_48555_48557;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4581__auto__));
})()));
} else
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_48559_48560 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_48559_48560,sb__4581__auto__,rule_tree){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_48559_48560,sb__4581__auto__,rule_tree))
;
cljs.core.println.call(null,rule_tree);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_48559_48560;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4581__auto__));
})()));
} else
