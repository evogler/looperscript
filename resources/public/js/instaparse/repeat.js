...
var get_end = null;
var get_end__1 = (function (parse){var vec__13310 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__13310,(0),null);var end = cljs.core.nth.call(null,vec__13310,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
{return cljs.core.count.call(null,parse);
}
});
var get_end__2 = (function (parse,index){var vec__13311 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__13311,(0),null);var end = cljs.core.nth.call(null,vec__13311,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
...
if(parses__$1)
{var parse = cljs.core.first.call(null,parses__$1);var vec__13313 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__13313,(0),null);var end = cljs.core.nth.call(null,vec__13313,(1),null);var end__$1 = (cljs.core.truth_(end)?end:(index + cljs.core.count.call(null,parse)));if(cljs.core._EQ_.call(null,end__$1,length))
...
{{
var G__13314 = cljs.core.next.call(null,parses__$1);
parses__$1 = G__13314;
continue;
}
}
...
var repeat_parse_hiccup__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.auto_flatten_seq.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [root_tag], null));var G__13320 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__13321 = G__13320;var parse = cljs.core.nth.call(null,vec__13321,(0),null);var end = cljs.core.nth.call(null,vec__13321,(1),null);var follow_ups = cljs.core.nth.call(null,vec__13321,(2),null);var selection = vec__13321;var index__$2 = index__$1;var parses__$1 = parses;var G__13320__$1 = G__13320;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__13322 = G__13320__$1;var parse__$1 = cljs.core.nth.call(null,vec__13322,(0),null);var end__$1 = cljs.core.nth.call(null,vec__13322,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__13322,(2),null);var selection__$1 = vec__13322;if((selection__$1 == null))
...
{{
var G__13323 = cljs.core.long$.call(null,end__$1);
var G__13324 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__13325 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__13323;
parses__$1 = G__13324;
G__13320__$1 = G__13325;
continue;
}
...
var repeat_parse_enlive__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__13331 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__13332 = G__13331;var parse = cljs.core.nth.call(null,vec__13332,(0),null);var end = cljs.core.nth.call(null,vec__13332,(1),null);var follow_ups = cljs.core.nth.call(null,vec__13332,(2),null);var selection = vec__13332;var index__$2 = index__$1;var parses__$1 = parses;var G__13331__$1 = G__13331;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__13333 = G__13331__$1;var parse__$1 = cljs.core.nth.call(null,vec__13333,(0),null);var end__$1 = cljs.core.nth.call(null,vec__13333,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__13333,(2),null);var selection__$1 = vec__13333;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
{{
var G__13334 = cljs.core.long$.call(null,end__$1);
var G__13335 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__13336 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__13334;
parses__$1 = G__13335;
G__13331__$1 = G__13336;
continue;
}
...
var repeat_parse_no_tag__5 = (function (grammar,initial_parser,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__13342 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__13343 = G__13342;var parse = cljs.core.nth.call(null,vec__13343,(0),null);var end = cljs.core.nth.call(null,vec__13343,(1),null);var follow_ups = cljs.core.nth.call(null,vec__13343,(2),null);var selection = vec__13343;var index__$2 = index__$1;var parses__$1 = parses;var G__13342__$1 = G__13342;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__13344 = G__13342__$1;var parse__$1 = cljs.core.nth.call(null,vec__13344,(0),null);var end__$1 = cljs.core.nth.call(null,vec__13344,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__13344,(2),null);var selection__$1 = vec__13344;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
{{
var G__13345 = cljs.core.long$.call(null,end__$1);
var G__13346 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__13347 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__13345;
parses__$1 = G__13346;
G__13342__$1 = G__13347;
continue;
}
...
{var G__13349 = (((output_format instanceof cljs.core.Keyword))?output_format.fqn:null);switch (G__13349) {
case "hiccup":
