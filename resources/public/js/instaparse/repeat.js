...
var get_end = null;
var get_end__1 = (function (parse){var vec__7689 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__7689,(0),null);var end = cljs.core.nth.call(null,vec__7689,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
{return cljs.core.count.call(null,parse);
}
});
var get_end__2 = (function (parse,index){var vec__7690 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__7690,(0),null);var end = cljs.core.nth.call(null,vec__7690,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
...
if(parses__$1)
{var parse = cljs.core.first.call(null,parses__$1);var vec__7692 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__7692,(0),null);var end = cljs.core.nth.call(null,vec__7692,(1),null);var end__$1 = (cljs.core.truth_(end)?end:(index + cljs.core.count.call(null,parse)));if(cljs.core._EQ_.call(null,end__$1,length))
...
var repeat_parse_hiccup__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.auto_flatten_seq.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [root_tag], null));var G__7699 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__7700 = G__7699;var parse = cljs.core.nth.call(null,vec__7700,(0),null);var end = cljs.core.nth.call(null,vec__7700,(1),null);var follow_ups = cljs.core.nth.call(null,vec__7700,(2),null);var selection = vec__7700;var index__$2 = index__$1;var parses__$1 = parses;var G__7699__$1 = G__7699;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__7701 = G__7699__$1;var parse__$1 = cljs.core.nth.call(null,vec__7701,(0),null);var end__$1 = cljs.core.nth.call(null,vec__7701,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__7701,(2),null);var selection__$1 = vec__7701;if((selection__$1 == null))
...
var repeat_parse_enlive__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__7710 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__7711 = G__7710;var parse = cljs.core.nth.call(null,vec__7711,(0),null);var end = cljs.core.nth.call(null,vec__7711,(1),null);var follow_ups = cljs.core.nth.call(null,vec__7711,(2),null);var selection = vec__7711;var index__$2 = index__$1;var parses__$1 = parses;var G__7710__$1 = G__7710;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__7712 = G__7710__$1;var parse__$1 = cljs.core.nth.call(null,vec__7712,(0),null);var end__$1 = cljs.core.nth.call(null,vec__7712,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__7712,(2),null);var selection__$1 = vec__7712;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
var repeat_parse_no_tag__5 = (function (grammar,initial_parser,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__7721 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__7722 = G__7721;var parse = cljs.core.nth.call(null,vec__7722,(0),null);var end = cljs.core.nth.call(null,vec__7722,(1),null);var follow_ups = cljs.core.nth.call(null,vec__7722,(2),null);var selection = vec__7722;var index__$2 = index__$1;var parses__$1 = parses;var G__7721__$1 = G__7721;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__7723 = G__7721__$1;var parse__$1 = cljs.core.nth.call(null,vec__7723,(0),null);var end__$1 = cljs.core.nth.call(null,vec__7723,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__7723,(2),null);var selection__$1 = vec__7723;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
{var G__7728 = (((output_format instanceof cljs.core.Keyword))?output_format.fqn:null);switch (G__7728) {
case "hiccup":
