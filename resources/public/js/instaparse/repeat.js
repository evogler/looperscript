...
var get_end = null;
var get_end__1 = (function (parse){var vec__14699 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__14699,(0),null);var end = cljs.core.nth.call(null,vec__14699,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
{return cljs.core.count.call(null,parse);
}
});
var get_end__2 = (function (parse,index){var vec__14700 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__14700,(0),null);var end = cljs.core.nth.call(null,vec__14700,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
...
if(parses__$1)
{var parse = cljs.core.first.call(null,parses__$1);var vec__14702 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__14702,(0),null);var end = cljs.core.nth.call(null,vec__14702,(1),null);var end__$1 = (cljs.core.truth_(end)?end:(index + cljs.core.count.call(null,parse)));if(cljs.core._EQ_.call(null,end__$1,length))
...
{{
var G__14703 = cljs.core.next.call(null,parses__$1);
parses__$1 = G__14703;
continue;
}
}
...
var repeat_parse_hiccup__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.auto_flatten_seq.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [root_tag], null));var G__14709 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__14710 = G__14709;var parse = cljs.core.nth.call(null,vec__14710,(0),null);var end = cljs.core.nth.call(null,vec__14710,(1),null);var follow_ups = cljs.core.nth.call(null,vec__14710,(2),null);var selection = vec__14710;var index__$2 = index__$1;var parses__$1 = parses;var G__14709__$1 = G__14709;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__14711 = G__14709__$1;var parse__$1 = cljs.core.nth.call(null,vec__14711,(0),null);var end__$1 = cljs.core.nth.call(null,vec__14711,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__14711,(2),null);var selection__$1 = vec__14711;if((selection__$1 == null))
...
{{
var G__14712 = cljs.core.long$.call(null,end__$1);
var G__14713 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__14714 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__14712;
parses__$1 = G__14713;
G__14709__$1 = G__14714;
continue;
}
...
var repeat_parse_enlive__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__14720 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__14721 = G__14720;var parse = cljs.core.nth.call(null,vec__14721,(0),null);var end = cljs.core.nth.call(null,vec__14721,(1),null);var follow_ups = cljs.core.nth.call(null,vec__14721,(2),null);var selection = vec__14721;var index__$2 = index__$1;var parses__$1 = parses;var G__14720__$1 = G__14720;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__14722 = G__14720__$1;var parse__$1 = cljs.core.nth.call(null,vec__14722,(0),null);var end__$1 = cljs.core.nth.call(null,vec__14722,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__14722,(2),null);var selection__$1 = vec__14722;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
{{
var G__14723 = cljs.core.long$.call(null,end__$1);
var G__14724 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__14725 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__14723;
parses__$1 = G__14724;
G__14720__$1 = G__14725;
continue;
}
...
var repeat_parse_no_tag__5 = (function (grammar,initial_parser,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__14731 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__14732 = G__14731;var parse = cljs.core.nth.call(null,vec__14732,(0),null);var end = cljs.core.nth.call(null,vec__14732,(1),null);var follow_ups = cljs.core.nth.call(null,vec__14732,(2),null);var selection = vec__14732;var index__$2 = index__$1;var parses__$1 = parses;var G__14731__$1 = G__14731;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__14733 = G__14731__$1;var parse__$1 = cljs.core.nth.call(null,vec__14733,(0),null);var end__$1 = cljs.core.nth.call(null,vec__14733,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__14733,(2),null);var selection__$1 = vec__14733;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
{{
var G__14734 = cljs.core.long$.call(null,end__$1);
var G__14735 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__14736 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__14734;
parses__$1 = G__14735;
G__14731__$1 = G__14736;
continue;
}
...
{var G__14738 = (((output_format instanceof cljs.core.Keyword))?output_format.fqn:null);switch (G__14738) {
case "hiccup":
