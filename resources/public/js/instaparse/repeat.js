...
var get_end = null;
var get_end__1 = (function (parse){var vec__44780 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__44780,(0),null);var end = cljs.core.nth.call(null,vec__44780,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
{return cljs.core.count.call(null,parse);
}
});
var get_end__2 = (function (parse,index){var vec__44781 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__44781,(0),null);var end = cljs.core.nth.call(null,vec__44781,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
...
if(parses__$1)
{var parse = cljs.core.first.call(null,parses__$1);var vec__44783 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__44783,(0),null);var end = cljs.core.nth.call(null,vec__44783,(1),null);var end__$1 = (cljs.core.truth_(end)?end:(index + cljs.core.count.call(null,parse)));if(cljs.core._EQ_.call(null,end__$1,length))
...
{{
var G__44784 = cljs.core.next.call(null,parses__$1);
parses__$1 = G__44784;
continue;
}
}
...
var repeat_parse_hiccup__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.auto_flatten_seq.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [root_tag], null));var G__44790 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__44791 = G__44790;var parse = cljs.core.nth.call(null,vec__44791,(0),null);var end = cljs.core.nth.call(null,vec__44791,(1),null);var follow_ups = cljs.core.nth.call(null,vec__44791,(2),null);var selection = vec__44791;var index__$2 = index__$1;var parses__$1 = parses;var G__44790__$1 = G__44790;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__44792 = G__44790__$1;var parse__$1 = cljs.core.nth.call(null,vec__44792,(0),null);var end__$1 = cljs.core.nth.call(null,vec__44792,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__44792,(2),null);var selection__$1 = vec__44792;if((selection__$1 == null))
...
{{
var G__44793 = cljs.core.long$.call(null,end__$1);
var G__44794 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__44795 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__44793;
parses__$1 = G__44794;
G__44790__$1 = G__44795;
continue;
}
...
var repeat_parse_enlive__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__44801 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__44802 = G__44801;var parse = cljs.core.nth.call(null,vec__44802,(0),null);var end = cljs.core.nth.call(null,vec__44802,(1),null);var follow_ups = cljs.core.nth.call(null,vec__44802,(2),null);var selection = vec__44802;var index__$2 = index__$1;var parses__$1 = parses;var G__44801__$1 = G__44801;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__44803 = G__44801__$1;var parse__$1 = cljs.core.nth.call(null,vec__44803,(0),null);var end__$1 = cljs.core.nth.call(null,vec__44803,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__44803,(2),null);var selection__$1 = vec__44803;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
{{
var G__44804 = cljs.core.long$.call(null,end__$1);
var G__44805 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__44806 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__44804;
parses__$1 = G__44805;
G__44801__$1 = G__44806;
continue;
}
...
var repeat_parse_no_tag__5 = (function (grammar,initial_parser,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__44812 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__44813 = G__44812;var parse = cljs.core.nth.call(null,vec__44813,(0),null);var end = cljs.core.nth.call(null,vec__44813,(1),null);var follow_ups = cljs.core.nth.call(null,vec__44813,(2),null);var selection = vec__44813;var index__$2 = index__$1;var parses__$1 = parses;var G__44812__$1 = G__44812;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__44814 = G__44812__$1;var parse__$1 = cljs.core.nth.call(null,vec__44814,(0),null);var end__$1 = cljs.core.nth.call(null,vec__44814,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__44814,(2),null);var selection__$1 = vec__44814;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
{{
var G__44815 = cljs.core.long$.call(null,end__$1);
var G__44816 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__44817 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__44815;
parses__$1 = G__44816;
G__44812__$1 = G__44817;
continue;
}
...
{var G__44819 = (((output_format instanceof cljs.core.Keyword))?output_format.fqn:null);switch (G__44819) {
case "hiccup":
