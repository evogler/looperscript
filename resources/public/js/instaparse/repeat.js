...
var get_end = null;
var get_end__1 = (function (parse){var vec__31819 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__31819,(0),null);var end = cljs.core.nth.call(null,vec__31819,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
{return cljs.core.count.call(null,parse);
}
});
var get_end__2 = (function (parse,index){var vec__31820 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__31820,(0),null);var end = cljs.core.nth.call(null,vec__31820,(1),null);if(cljs.core.truth_(end))
{return cljs.core.long$.call(null,end);
} else
...
if(parses__$1)
{var parse = cljs.core.first.call(null,parses__$1);var vec__31822 = instaparse.viz.span.call(null,parse);var start = cljs.core.nth.call(null,vec__31822,(0),null);var end = cljs.core.nth.call(null,vec__31822,(1),null);var end__$1 = (cljs.core.truth_(end)?end:(index + cljs.core.count.call(null,parse)));if(cljs.core._EQ_.call(null,end__$1,length))
...
var repeat_parse_hiccup__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.auto_flatten_seq.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [root_tag], null));var G__31829 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__31830 = G__31829;var parse = cljs.core.nth.call(null,vec__31830,(0),null);var end = cljs.core.nth.call(null,vec__31830,(1),null);var follow_ups = cljs.core.nth.call(null,vec__31830,(2),null);var selection = vec__31830;var index__$2 = index__$1;var parses__$1 = parses;var G__31829__$1 = G__31829;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__31831 = G__31829__$1;var parse__$1 = cljs.core.nth.call(null,vec__31831,(0),null);var end__$1 = cljs.core.nth.call(null,vec__31831,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__31831,(2),null);var selection__$1 = vec__31831;if((selection__$1 == null))
...
var repeat_parse_enlive__6 = (function (grammar,initial_parser,root_tag,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__31840 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__31841 = G__31840;var parse = cljs.core.nth.call(null,vec__31841,(0),null);var end = cljs.core.nth.call(null,vec__31841,(1),null);var follow_ups = cljs.core.nth.call(null,vec__31841,(2),null);var selection = vec__31841;var index__$2 = index__$1;var parses__$1 = parses;var G__31840__$1 = G__31840;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__31842 = G__31840__$1;var parse__$1 = cljs.core.nth.call(null,vec__31842,(0),null);var end__$1 = cljs.core.nth.call(null,vec__31842,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__31842,(2),null);var selection__$1 = vec__31842;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
var repeat_parse_no_tag__5 = (function (grammar,initial_parser,text,segment,index){var length = cljs.core.count.call(null,text);var first_result = instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,index);var index__$1 = cljs.core.long$.call(null,index);var parses = instaparse.auto_flatten_seq.EMPTY;var G__31851 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);var vec__31852 = G__31851;var parse = cljs.core.nth.call(null,vec__31852,(0),null);var end = cljs.core.nth.call(null,vec__31852,(1),null);var follow_ups = cljs.core.nth.call(null,vec__31852,(2),null);var selection = vec__31852;var index__$2 = index__$1;var parses__$1 = parses;var G__31851__$1 = G__31851;while(true){
var index__$3 = index__$2;var parses__$2 = parses__$1;var vec__31853 = G__31851__$1;var parse__$1 = cljs.core.nth.call(null,vec__31853,(0),null);var end__$1 = cljs.core.nth.call(null,vec__31853,(1),null);var follow_ups__$1 = cljs.core.nth.call(null,vec__31853,(2),null);var selection__$1 = vec__31853;if((selection__$1 == null))
{return instaparse.repeat.failure_signal;
} else
{if(cljs.core._EQ_.call(null,index__$3,end__$1))
{return instaparse.repeat.failure_signal;
...
{var G__31858 = (((output_format instanceof cljs.core.Keyword))?output_format.fqn:null);switch (G__31858) {
case "hiccup":
