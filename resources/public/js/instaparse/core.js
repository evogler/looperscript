...
instaparse.core.unhide_parser = (function unhide_parser(parser,unhide){var G__31787 = unhide;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"all","all",892129742),G__31787))
...
var p__31788 = null;if (arguments.length > 2) {
...
var parses__delegate = function (parser,text,p__31792){var map__31794 = p__31792;var map__31794__$1 = ((cljs.core.seq_QMARK_.call(null,map__31794))?cljs.core.apply.call(null,cljs.core.hash_map,map__31794):map__31794);var options = map__31794__$1;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.call(null,options,new cljs.core.Keyword(null,"unhide","unhide",-413983695))))
{} else
{throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"contains?","contains?",-1676812576,null),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.list(new cljs.core.Symbol(null,"get","get",-971253014,null),new cljs.core.Symbol(null,"options","options",1740170016,null),new cljs.core.Keyword(null,"unhide","unhide",-413983695))))))));
}
...
var p__31792 = null;if (arguments.length > 2) {
...
instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4238__auto__,k31797,else__4239__auto__){var self__ = this;
var this__4238__auto____$1 = this;var G__31800 = (((k31797 instanceof cljs.core.Keyword))?k31797.fqn:null);switch (G__31800) {
case "output-format":
...
instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4243__auto__,k__4244__auto__,G__31796){var self__ = this;
var this__4243__auto____$1 = this;var pred__31801 = cljs.core.keyword_identical_QMARK_;var expr__31802 = k__4244__auto__;if(cljs.core.truth_(pred__31801.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__31802)))
...
instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4235__auto__,G__31796){var self__ = this;
var this__4235__auto____$1 = this;return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__31796,self__.__extmap,self__.__hash));
});
...
;
instaparse.core.Parser.prototype.apply = (function (self__,args31799){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args31799)));
});
...
instaparse.core.map__GT_Parser = (function map__GT_Parser(G__31798){return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__31798),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__31798),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__31798),null,cljs.core.dissoc.call(null,G__31798,new cljs.core.Keyword(null,"grammar","grammar",1881328267),new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676))));
});
...
var parser__delegate = function (grammar_specification,p__31806){var map__31811 = p__31806;var map__31811__$1 = ((cljs.core.seq_QMARK_.call(null,map__31811))?cljs.core.apply.call(null,cljs.core.hash_map,map__31811):map__31811);var options = map__31811__$1;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [null,null,new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null),cljs.core.get.call(null,options,new cljs.core.Keyword(null,"input-format","input-format",-422703481))))
{} else
...
var input_format = cljs.core.get.call(null,options,new cljs.core.Keyword(null,"input-format","input-format",-422703481),instaparse.core._STAR_default_input_format_STAR_);var build_parser = (function (){var G__31812 = (((input_format instanceof cljs.core.Keyword))?input_format.fqn:null);switch (G__31812) {
case "ebnf":
...
return (function (spec,output_format){var _STAR_case_insensitive_literals_STAR_31813 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;try{instaparse.cfg._STAR_case_insensitive_literals_STAR_ = true;
return instaparse.cfg.build_parser.call(null,spec,output_format);
}finally {instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR_31813;
}});
...
{var map__31814 = temp__4124__auto__;var map__31814__$1 = ((cljs.core.seq_QMARK_.call(null,map__31814))?cljs.core.apply.call(null,cljs.core.hash_map,map__31814):map__31814);var ws_grammar = cljs.core.get.call(null,map__31814__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));var ws_start = cljs.core.get.call(null,map__31814__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));return cljs.core.assoc.call(null,built_parser,new cljs.core.Keyword(null,"grammar","grammar",1881328267),instaparse.combinators_source.auto_whitespace.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(built_parser),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(built_parser),ws_grammar,ws_start));
} else
{return built_parser;
}
};
var parser = function (grammar_specification,var_args){
var p__31806 = null;if (arguments.length > 1) {
