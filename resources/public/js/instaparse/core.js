...
instaparse.core.unhide_parser = (function unhide_parser(parser,unhide){var G__34225 = unhide;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"all","all",892129742),G__34225))
...
var p__34226 = null;if (arguments.length > 2) {
...
var parses__delegate = function (parser,text,p__34230){var map__34232 = p__34230;var map__34232__$1 = ((cljs.core.seq_QMARK_.call(null,map__34232))?cljs.core.apply.call(null,cljs.core.hash_map,map__34232):map__34232);var options = map__34232__$1;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.call(null,options,new cljs.core.Keyword(null,"unhide","unhide",-413983695))))
{} else
{throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"contains?","contains?",-1676812576,null),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.list(new cljs.core.Symbol(null,"get","get",-971253014,null),new cljs.core.Symbol(null,"options","options",1740170016,null),new cljs.core.Keyword(null,"unhide","unhide",-413983695))))))));
}
...
var p__34230 = null;if (arguments.length > 2) {
...
instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4238__auto__,k34235,else__4239__auto__){var self__ = this;
var this__4238__auto____$1 = this;var G__34238 = (((k34235 instanceof cljs.core.Keyword))?k34235.fqn:null);switch (G__34238) {
case "output-format":
...
instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4243__auto__,k__4244__auto__,G__34234){var self__ = this;
var this__4243__auto____$1 = this;var pred__34239 = cljs.core.keyword_identical_QMARK_;var expr__34240 = k__4244__auto__;if(cljs.core.truth_(pred__34239.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__34240)))
...
instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4235__auto__,G__34234){var self__ = this;
var this__4235__auto____$1 = this;return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__34234,self__.__extmap,self__.__hash));
});
...
;
instaparse.core.Parser.prototype.apply = (function (self__,args34237){var self__ = this;
...
instaparse.core.map__GT_Parser = (function map__GT_Parser(G__34236){return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__34236),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__34236),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__34236),null,cljs.core.dissoc.call(null,G__34236,new cljs.core.Keyword(null,"grammar","grammar",1881328267),new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676))));
});
...
var parser__delegate = function (grammar_specification,p__34244){var map__34249 = p__34244;var map__34249__$1 = ((cljs.core.seq_QMARK_.call(null,map__34249))?cljs.core.apply.call(null,cljs.core.hash_map,map__34249):map__34249);var options = map__34249__$1;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [null,null,new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null),cljs.core.get.call(null,options,new cljs.core.Keyword(null,"input-format","input-format",-422703481))))
{} else
...
var input_format = cljs.core.get.call(null,options,new cljs.core.Keyword(null,"input-format","input-format",-422703481),instaparse.core._STAR_default_input_format_STAR_);var build_parser = (function (){var G__34250 = (((input_format instanceof cljs.core.Keyword))?input_format.fqn:null);switch (G__34250) {
case "ebnf":
...
return (function (spec,output_format){var _STAR_case_insensitive_literals_STAR_34251 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;try{instaparse.cfg._STAR_case_insensitive_literals_STAR_ = true;
return instaparse.cfg.build_parser.call(null,spec,output_format);
}finally {instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR_34251;
}});
