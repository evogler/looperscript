...
instaparse.core.unhide_parser = (function unhide_parser(parser,unhide){var G__13643 = unhide;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"all","all",892129742),G__13643))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"tags","tags",1771418977),G__13643))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"content","content",15833224),G__13643))
...
{if(cljs.core._EQ_.call(null,null,G__13643))
{return parser;
} else
...
var p__13644 = null;if (arguments.length > 2) {
  p__13644 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return parse__delegate.call(this,parser,text,p__13644);};
parse.cljs$lang$maxFixedArity = 2;
parse.cljs$lang$applyTo = (function (arglist__13647){
var parser = cljs.core.first(arglist__13647);
arglist__13647 = cljs.core.next(arglist__13647);
var text = cljs.core.first(arglist__13647);
var p__13644 = cljs.core.rest(arglist__13647);
return parse__delegate(parser,text,p__13644);
});
...
var parses__delegate = function (parser,text,p__13648){var map__13650 = p__13648;var map__13650__$1 = ((cljs.core.seq_QMARK_.call(null,map__13650))?cljs.core.apply.call(null,cljs.core.hash_map,map__13650):map__13650);var options = map__13650__$1;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.call(null,options,new cljs.core.Keyword(null,"unhide","unhide",-413983695))))
{} else
{throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"contains?","contains?",-1676812576,null),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.list(new cljs.core.Symbol(null,"get","get",-971253014,null),new cljs.core.Symbol(null,"options","options",1740170016,null),new cljs.core.Keyword(null,"unhide","unhide",-413983695))))))));
}
...
var p__13648 = null;if (arguments.length > 2) {
  p__13648 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return parses__delegate.call(this,parser,text,p__13648);};
parses.cljs$lang$maxFixedArity = 2;
parses.cljs$lang$applyTo = (function (arglist__13651){
var parser = cljs.core.first(arglist__13651);
arglist__13651 = cljs.core.next(arglist__13651);
var text = cljs.core.first(arglist__13651);
var p__13648 = cljs.core.rest(arglist__13651);
return parses__delegate(parser,text,p__13648);
});
...
instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4238__auto__,k13653,else__4239__auto__){var self__ = this;
var this__4238__auto____$1 = this;var G__13656 = (((k13653 instanceof cljs.core.Keyword))?k13653.fqn:null);switch (G__13656) {
case "output-format":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k13653,else__4239__auto__);
...
instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4243__auto__,k__4244__auto__,G__13652){var self__ = this;
var this__4243__auto____$1 = this;var pred__13657 = cljs.core.keyword_identical_QMARK_;var expr__13658 = k__4244__auto__;if(cljs.core.truth_(pred__13657.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__13658)))
{return (new instaparse.core.Parser(G__13652,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__13657.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__13658)))
{return (new instaparse.core.Parser(self__.grammar,G__13652,self__.output_format,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__13657.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__13658)))
{return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__13652,self__.__meta,self__.__extmap,null));
} else
{return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4244__auto__,G__13652),null));
}
}
}
});
...
instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4235__auto__,G__13652){var self__ = this;
var this__4235__auto____$1 = this;return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__13652,self__.__extmap,self__.__hash));
});
...
G__13661 = function(self__,text,key1,val1,key2,val2,key3,val3){
switch(arguments.length){
case 2:
return G__13661__2.call(this,self__,text);
case 4:
return G__13661__4.call(this,self__,text,key1,val1);
case 6:
return G__13661__6.call(this,self__,text,key1,val1,key2,val2);
case 8:
return G__13661__8.call(this,self__,text,key1,val1,key2,val2,key3,val3);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__13661.cljs$core$IFn$_invoke$arity$2 = G__13661__2;
G__13661.cljs$core$IFn$_invoke$arity$4 = G__13661__4;
G__13661.cljs$core$IFn$_invoke$arity$6 = G__13661__6;
G__13661.cljs$core$IFn$_invoke$arity$8 = G__13661__8;
return G__13661;
})()
;
instaparse.core.Parser.prototype.apply = (function (self__,args13655){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args13655)));
});
...
instaparse.core.map__GT_Parser = (function map__GT_Parser(G__13654){return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__13654),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__13654),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__13654),null,cljs.core.dissoc.call(null,G__13654,new cljs.core.Keyword(null,"grammar","grammar",1881328267),new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676))));
});
...
var parser__delegate = function (grammar_specification,p__13662){var map__13667 = p__13662;var map__13667__$1 = ((cljs.core.seq_QMARK_.call(null,map__13667))?cljs.core.apply.call(null,cljs.core.hash_map,map__13667):map__13667);var options = map__13667__$1;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [null,null,new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null),cljs.core.get.call(null,options,new cljs.core.Keyword(null,"input-format","input-format",-422703481))))
{} else
...
var input_format = cljs.core.get.call(null,options,new cljs.core.Keyword(null,"input-format","input-format",-422703481),instaparse.core._STAR_default_input_format_STAR_);var build_parser = (function (){var G__13668 = (((input_format instanceof cljs.core.Keyword))?input_format.fqn:null);switch (G__13668) {
case "ebnf":
if(cljs.core.truth_(cljs.core.get.call(null,options,new cljs.core.Keyword(null,"string-ci","string-ci",374631805))))
{return ((function (G__13668,input_format,map__13667,map__13667__$1,options){
return (function (spec,output_format){var _STAR_case_insensitive_literals_STAR_13669 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;try{instaparse.cfg._STAR_case_insensitive_literals_STAR_ = true;
return instaparse.cfg.build_parser.call(null,spec,output_format);
}finally {instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR_13669;
}});
;})(G__13668,input_format,map__13667,map__13667__$1,options))
} else
...
{var map__13670 = temp__4124__auto__;var map__13670__$1 = ((cljs.core.seq_QMARK_.call(null,map__13670))?cljs.core.apply.call(null,cljs.core.hash_map,map__13670):map__13670);var ws_grammar = cljs.core.get.call(null,map__13670__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));var ws_start = cljs.core.get.call(null,map__13670__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));return cljs.core.assoc.call(null,built_parser,new cljs.core.Keyword(null,"grammar","grammar",1881328267),instaparse.combinators_source.auto_whitespace.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(built_parser),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(built_parser),ws_grammar,ws_start));
} else
{return built_parser;
}
};
var parser = function (grammar_specification,var_args){
var p__13662 = null;if (arguments.length > 1) {
  p__13662 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return parser__delegate.call(this,grammar_specification,p__13662);};
parser.cljs$lang$maxFixedArity = 1;
parser.cljs$lang$applyTo = (function (arglist__13672){
var grammar_specification = cljs.core.first(arglist__13672);
var p__13662 = cljs.core.rest(arglist__13672);
return parser__delegate(grammar_specification,p__13662);
});
