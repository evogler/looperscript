...
instaparse.core.unhide_parser = (function unhide_parser(parser,unhide){var G__14667 = unhide;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"all","all",892129742),G__14667))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"tags","tags",1771418977),G__14667))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"content","content",15833224),G__14667))
...
{if(cljs.core._EQ_.call(null,null,G__14667))
{return parser;
} else
...
var p__14668 = null;if (arguments.length > 2) {
  p__14668 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return parse__delegate.call(this,parser,text,p__14668);};
parse.cljs$lang$maxFixedArity = 2;
parse.cljs$lang$applyTo = (function (arglist__14671){
var parser = cljs.core.first(arglist__14671);
arglist__14671 = cljs.core.next(arglist__14671);
var text = cljs.core.first(arglist__14671);
var p__14668 = cljs.core.rest(arglist__14671);
return parse__delegate(parser,text,p__14668);
});
...
var parses__delegate = function (parser,text,p__14672){var map__14674 = p__14672;var map__14674__$1 = ((cljs.core.seq_QMARK_.call(null,map__14674))?cljs.core.apply.call(null,cljs.core.hash_map,map__14674):map__14674);var options = map__14674__$1;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.call(null,options,new cljs.core.Keyword(null,"unhide","unhide",-413983695))))
{} else
{throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"contains?","contains?",-1676812576,null),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.list(new cljs.core.Symbol(null,"get","get",-971253014,null),new cljs.core.Symbol(null,"options","options",1740170016,null),new cljs.core.Keyword(null,"unhide","unhide",-413983695))))))));
}
...
var p__14672 = null;if (arguments.length > 2) {
  p__14672 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return parses__delegate.call(this,parser,text,p__14672);};
parses.cljs$lang$maxFixedArity = 2;
parses.cljs$lang$applyTo = (function (arglist__14675){
var parser = cljs.core.first(arglist__14675);
arglist__14675 = cljs.core.next(arglist__14675);
var text = cljs.core.first(arglist__14675);
var p__14672 = cljs.core.rest(arglist__14675);
return parses__delegate(parser,text,p__14672);
});
...
instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4238__auto__,k14677,else__4239__auto__){var self__ = this;
var this__4238__auto____$1 = this;var G__14680 = (((k14677 instanceof cljs.core.Keyword))?k14677.fqn:null);switch (G__14680) {
case "output-format":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k14677,else__4239__auto__);
...
instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4243__auto__,k__4244__auto__,G__14676){var self__ = this;
var this__4243__auto____$1 = this;var pred__14681 = cljs.core.keyword_identical_QMARK_;var expr__14682 = k__4244__auto__;if(cljs.core.truth_(pred__14681.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__14682)))
{return (new instaparse.core.Parser(G__14676,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__14681.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__14682)))
{return (new instaparse.core.Parser(self__.grammar,G__14676,self__.output_format,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__14681.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__14682)))
{return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__14676,self__.__meta,self__.__extmap,null));
} else
{return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4244__auto__,G__14676),null));
}
}
}
});
...
instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4235__auto__,G__14676){var self__ = this;
var this__4235__auto____$1 = this;return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__14676,self__.__extmap,self__.__hash));
});
...
G__14685 = function(self__,text,key1,val1,key2,val2,key3,val3){
switch(arguments.length){
case 2:
return G__14685__2.call(this,self__,text);
case 4:
return G__14685__4.call(this,self__,text,key1,val1);
case 6:
return G__14685__6.call(this,self__,text,key1,val1,key2,val2);
case 8:
return G__14685__8.call(this,self__,text,key1,val1,key2,val2,key3,val3);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__14685.cljs$core$IFn$_invoke$arity$2 = G__14685__2;
G__14685.cljs$core$IFn$_invoke$arity$4 = G__14685__4;
G__14685.cljs$core$IFn$_invoke$arity$6 = G__14685__6;
G__14685.cljs$core$IFn$_invoke$arity$8 = G__14685__8;
return G__14685;
})()
;
instaparse.core.Parser.prototype.apply = (function (self__,args14679){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args14679)));
});
...
instaparse.core.map__GT_Parser = (function map__GT_Parser(G__14678){return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__14678),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__14678),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__14678),null,cljs.core.dissoc.call(null,G__14678,new cljs.core.Keyword(null,"grammar","grammar",1881328267),new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676))));
});
...
var parser__delegate = function (grammar_specification,p__14686){var map__14691 = p__14686;var map__14691__$1 = ((cljs.core.seq_QMARK_.call(null,map__14691))?cljs.core.apply.call(null,cljs.core.hash_map,map__14691):map__14691);var options = map__14691__$1;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [null,null,new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null),cljs.core.get.call(null,options,new cljs.core.Keyword(null,"input-format","input-format",-422703481))))
{} else
...
var input_format = cljs.core.get.call(null,options,new cljs.core.Keyword(null,"input-format","input-format",-422703481),instaparse.core._STAR_default_input_format_STAR_);var build_parser = (function (){var G__14692 = (((input_format instanceof cljs.core.Keyword))?input_format.fqn:null);switch (G__14692) {
case "ebnf":
if(cljs.core.truth_(cljs.core.get.call(null,options,new cljs.core.Keyword(null,"string-ci","string-ci",374631805))))
{return ((function (G__14692,input_format,map__14691,map__14691__$1,options){
return (function (spec,output_format){var _STAR_case_insensitive_literals_STAR_14693 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;try{instaparse.cfg._STAR_case_insensitive_literals_STAR_ = true;
return instaparse.cfg.build_parser.call(null,spec,output_format);
}finally {instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR_14693;
}});
;})(G__14692,input_format,map__14691,map__14691__$1,options))
} else
...
{var map__14694 = temp__4124__auto__;var map__14694__$1 = ((cljs.core.seq_QMARK_.call(null,map__14694))?cljs.core.apply.call(null,cljs.core.hash_map,map__14694):map__14694);var ws_grammar = cljs.core.get.call(null,map__14694__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));var ws_start = cljs.core.get.call(null,map__14694__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));return cljs.core.assoc.call(null,built_parser,new cljs.core.Keyword(null,"grammar","grammar",1881328267),instaparse.combinators_source.auto_whitespace.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(built_parser),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(built_parser),ws_grammar,ws_start));
} else
{return built_parser;
}
};
var parser = function (grammar_specification,var_args){
var p__14686 = null;if (arguments.length > 1) {
  p__14686 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return parser__delegate.call(this,grammar_specification,p__14686);};
parser.cljs$lang$maxFixedArity = 1;
parser.cljs$lang$applyTo = (function (arglist__14696){
var grammar_specification = cljs.core.first(arglist__14696);
var p__14686 = cljs.core.rest(arglist__14696);
return parser__delegate(grammar_specification,p__14686);
});
