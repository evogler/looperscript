...
{var c = temp__4124__auto__;var G__48562 = c;switch (G__48562) {
case "\\":
...
{{
var G__48564 = cljs.core.drop.call(null,(2),sq);
var G__48565 = cljs.core.conj.call(null,v,c2);
sq = G__48564;
v = G__48565;
continue;
}
...
{{
var G__48566 = cljs.core.drop.call(null,(2),sq);
var G__48567 = cljs.core.conj.call(null,v,c,c2);
sq = G__48566;
v = G__48567;
continue;
}
...
case "\"":
{
var G__48568 = cljs.core.next.call(null,sq);
var G__48569 = cljs.core.conj.call(null,v,"\\","\"");
sq = G__48568;
v = G__48569;
continue;
}
...
default:
{
var G__48570 = cljs.core.next.call(null,sq);
var G__48571 = cljs.core.conj.call(null,v,c);
sq = G__48570;
v = G__48571;
continue;
}
...
var G__48574 = (((instaparse.cfg.tag.call(null,tree) instanceof cljs.core.Keyword))?instaparse.cfg.tag.call(null,tree).fqn:null);switch (G__48574) {
case "neg":
...
break;
case "rule":
var vec__48575 = instaparse.cfg.contents.call(null,tree);var nt = cljs.core.nth.call(null,vec__48575,(0),null);var alt_or_ord = cljs.core.nth.call(null,vec__48575,(1),null);if(cljs.core._EQ_.call(null,instaparse.cfg.tag.call(null,nt),new cljs.core.Keyword(null,"hide-nt","hide-nt",-228813845)))
...
case "paren":
{
var G__48577 = instaparse.cfg.content.call(null,tree);
tree = G__48577;
continue;
}
...
var G__48579 = (((new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser).fqn:null);switch (G__48579) {
case "neg":
{
var G__48581 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__48581;
continue;
}
...
case "look":
{
var G__48582 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__48582;
continue;
}
...
case "rep":
{
var G__48583 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__48583;
continue;
}
...
case "star":
{
var G__48584 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__48584;
continue;
}
...
case "plus":
{
var G__48585 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__48585;
continue;
}
...
case "opt":
{
var G__48586 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__48586;
continue;
}
...
*/
instaparse.cfg.check_grammar = (function check_grammar(grammar_map){var valid_nts_48595 = cljs.core.set.call(null,cljs.core.keys.call(null,grammar_map));var seq__48591_48596 = cljs.core.seq.call(null,cljs.core.distinct.call(null,cljs.core.mapcat.call(null,instaparse.cfg.seq_nt,cljs.core.vals.call(null,grammar_map))));var chunk__48592_48597 = null;var count__48593_48598 = (0);var i__48594_48599 = (0);while(true){
if((i__48594_48599 < count__48593_48598))
{var nt_48600 = cljs.core._nth.call(null,chunk__48592_48597,i__48594_48599);if(cljs.core.truth_(valid_nts_48595.call(null,nt_48600)))
{} else
{throw (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_48600)),(1)))+"occurs on the right-hand side of your grammar, but not on the left");
}
{
var G__48601 = seq__48591_48596;
var G__48602 = chunk__48592_48597;
var G__48603 = count__48593_48598;
var G__48604 = (i__48594_48599 + (1));
seq__48591_48596 = G__48601;
chunk__48592_48597 = G__48602;
count__48593_48598 = G__48603;
i__48594_48599 = G__48604;
continue;
}
} else
{var temp__4126__auto___48605 = cljs.core.seq.call(null,seq__48591_48596);if(temp__4126__auto___48605)
{var seq__48591_48606__$1 = temp__4126__auto___48605;if(cljs.core.chunked_seq_QMARK_.call(null,seq__48591_48606__$1))
{var c__4410__auto___48607 = cljs.core.chunk_first.call(null,seq__48591_48606__$1);{
var G__48608 = cljs.core.chunk_rest.call(null,seq__48591_48606__$1);
var G__48609 = c__4410__auto___48607;
var G__48610 = cljs.core.count.call(null,c__4410__auto___48607);
var G__48611 = (0);
seq__48591_48596 = G__48608;
chunk__48592_48597 = G__48609;
count__48593_48598 = G__48610;
i__48594_48599 = G__48611;
continue;
}
} else
{var nt_48612 = cljs.core.first.call(null,seq__48591_48606__$1);if(cljs.core.truth_(valid_nts_48595.call(null,nt_48612)))
{} else
{throw (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_48612)),(1)))+"occurs on the right-hand side of your grammar, but not on the left");
}
{
var G__48613 = cljs.core.next.call(null,seq__48591_48606__$1);
var G__48614 = null;
var G__48615 = (0);
var G__48616 = (0);
seq__48591_48596 = G__48613;
chunk__48592_48597 = G__48614;
count__48593_48598 = G__48615;
i__48594_48599 = G__48616;
continue;
}
}
} else
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_48618_48619 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_48618_48619,sb__4581__auto__,rules){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_48618_48619,sb__4581__auto__,rules))
;
cljs.core.println.call(null,rules);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_48618_48619;
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_48622_48624 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_48622_48624,sb__4581__auto__,rules){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_48622_48624,sb__4581__auto__,rules))
;
cljs.core.println.call(null,rules);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_48622_48624;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4581__auto__));
})()));
} else
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_48623_48625 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_48623_48625,sb__4581__auto__,rhs){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_48623_48625,sb__4581__auto__,rhs))
;
cljs.core.println.call(null,rhs);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_48623_48625;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4581__auto__));
})()));
} else
