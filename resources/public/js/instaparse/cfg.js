...
{var c = temp__4124__auto__;var G__21574 = c;switch (G__21574) {
case "\\":
...
{{
var G__21576 = cljs.core.drop.call(null,(2),sq);
var G__21577 = cljs.core.conj.call(null,v,c2);
sq = G__21576;
v = G__21577;
continue;
}
...
{{
var G__21578 = cljs.core.drop.call(null,(2),sq);
var G__21579 = cljs.core.conj.call(null,v,c,c2);
sq = G__21578;
v = G__21579;
continue;
}
...
case "\"":
{
var G__21580 = cljs.core.next.call(null,sq);
var G__21581 = cljs.core.conj.call(null,v,"\\","\"");
sq = G__21580;
v = G__21581;
continue;
}
...
default:
{
var G__21582 = cljs.core.next.call(null,sq);
var G__21583 = cljs.core.conj.call(null,v,c);
sq = G__21582;
v = G__21583;
continue;
}
...
var G__21586 = (((instaparse.cfg.tag.call(null,tree) instanceof cljs.core.Keyword))?instaparse.cfg.tag.call(null,tree).fqn:null);switch (G__21586) {
case "neg":
...
break;
case "rule":
var vec__21587 = instaparse.cfg.contents.call(null,tree);var nt = cljs.core.nth.call(null,vec__21587,(0),null);var alt_or_ord = cljs.core.nth.call(null,vec__21587,(1),null);if(cljs.core._EQ_.call(null,instaparse.cfg.tag.call(null,nt),new cljs.core.Keyword(null,"hide-nt","hide-nt",-228813845)))
...
case "paren":
{
var G__21589 = instaparse.cfg.content.call(null,tree);
tree = G__21589;
continue;
}
...
var G__21591 = (((new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser).fqn:null);switch (G__21591) {
case "neg":
{
var G__21593 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__21593;
continue;
}
...
case "look":
{
var G__21594 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__21594;
continue;
}
...
case "rep":
{
var G__21595 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__21595;
continue;
}
...
case "star":
{
var G__21596 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__21596;
continue;
}
...
case "plus":
{
var G__21597 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__21597;
continue;
}
...
case "opt":
{
var G__21598 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__21598;
continue;
}
...
*/
instaparse.cfg.check_grammar = (function check_grammar(grammar_map){var valid_nts_21607 = cljs.core.set.call(null,cljs.core.keys.call(null,grammar_map));var seq__21603_21608 = cljs.core.seq.call(null,cljs.core.distinct.call(null,cljs.core.mapcat.call(null,instaparse.cfg.seq_nt,cljs.core.vals.call(null,grammar_map))));var chunk__21604_21609 = null;var count__21605_21610 = (0);var i__21606_21611 = (0);while(true){
if((i__21606_21611 < count__21605_21610))
{var nt_21612 = cljs.core._nth.call(null,chunk__21604_21609,i__21606_21611);if(cljs.core.truth_(valid_nts_21607.call(null,nt_21612)))
{} else
{throw (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_21612)),(1)))+"occurs on the right-hand side of your grammar, but not on the left");
}
{
var G__21613 = seq__21603_21608;
var G__21614 = chunk__21604_21609;
var G__21615 = count__21605_21610;
var G__21616 = (i__21606_21611 + (1));
seq__21603_21608 = G__21613;
chunk__21604_21609 = G__21614;
count__21605_21610 = G__21615;
i__21606_21611 = G__21616;
continue;
}
} else
{var temp__4126__auto___21617 = cljs.core.seq.call(null,seq__21603_21608);if(temp__4126__auto___21617)
{var seq__21603_21618__$1 = temp__4126__auto___21617;if(cljs.core.chunked_seq_QMARK_.call(null,seq__21603_21618__$1))
{var c__4410__auto___21619 = cljs.core.chunk_first.call(null,seq__21603_21618__$1);{
var G__21620 = cljs.core.chunk_rest.call(null,seq__21603_21618__$1);
var G__21621 = c__4410__auto___21619;
var G__21622 = cljs.core.count.call(null,c__4410__auto___21619);
var G__21623 = (0);
seq__21603_21608 = G__21620;
chunk__21604_21609 = G__21621;
count__21605_21610 = G__21622;
i__21606_21611 = G__21623;
continue;
}
} else
{var nt_21624 = cljs.core.first.call(null,seq__21603_21618__$1);if(cljs.core.truth_(valid_nts_21607.call(null,nt_21624)))
{} else
{throw (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_21624)),(1)))+"occurs on the right-hand side of your grammar, but not on the left");
}
{
var G__21625 = cljs.core.next.call(null,seq__21603_21618__$1);
var G__21626 = null;
var G__21627 = (0);
var G__21628 = (0);
seq__21603_21608 = G__21625;
chunk__21604_21609 = G__21626;
count__21605_21610 = G__21627;
i__21606_21611 = G__21628;
continue;
}
}
} else
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_21630_21631 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_21630_21631,sb__4581__auto__,rules){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_21630_21631,sb__4581__auto__,rules))
;
cljs.core.println.call(null,rules);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_21630_21631;
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_21634_21636 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_21634_21636,sb__4581__auto__,rules){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_21634_21636,sb__4581__auto__,rules))
;
cljs.core.println.call(null,rules);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_21634_21636;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4581__auto__));
})()));
} else
...
{throw ("Error parsing grammar specification:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var sb__4581__auto__ = (new goog.string.StringBuffer());var _STAR_print_fn_STAR_21635_21637 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_fn_STAR_21635_21637,sb__4581__auto__,rhs){
return (function (x__4582__auto__){return sb__4581__auto__.append(x__4582__auto__);
});})(_STAR_print_fn_STAR_21635_21637,sb__4581__auto__,rhs))
;
cljs.core.println.call(null,rhs);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_21635_21637;
}return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4581__auto__));
})()));
} else
