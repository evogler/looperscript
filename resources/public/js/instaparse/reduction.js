...
instaparse.reduction.apply_reduction = (function apply_reduction(f,result){var G__21055 = (((new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f).fqn:null);switch (G__21055) {
case "enlive":
...
return (function iter__21065(s__21066){return (new cljs.core.LazySeq(null,((function (reduction,temp__4124__auto__){
return (function (){var s__21066__$1 = s__21066;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__21066__$1);if(temp__4126__auto__)
{var s__21066__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__21066__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__21066__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__21068 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__21067 = (0);while(true){
if((i__21067 < size__4378__auto__))
{var vec__21071 = cljs.core._nth.call(null,c__4377__auto__,i__21067);var k = cljs.core.nth.call(null,vec__21071,(0),null);var v = cljs.core.nth.call(null,vec__21071,(1),null);cljs.core.chunk_append.call(null,b__21068,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.call(null,v,new cljs.core.Keyword(null,"red","red",-969428204),reduction.call(null,k))], null)));
{
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21068),iter__21065.call(null,cljs.core.chunk_rest.call(null,s__21066__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21068),null);
}
} else
{var vec__21072 = cljs.core.first.call(null,s__21066__$2);var k = cljs.core.nth.call(null,vec__21072,(0),null);var v = cljs.core.nth.call(null,vec__21072,(1),null);return cljs.core.cons.call(null,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.call(null,v,new cljs.core.Keyword(null,"red","red",-969428204),reduction.call(null,k))], null)),iter__21065.call(null,cljs.core.rest.call(null,s__21066__$2)));
}
} else
{return null;
}
