...
var ord__2 = (function() { 
var G__32351__delegate = function (parser1,parsers){var parsers__$1 = ((cljs.core._EQ_.call(null,parser1,instaparse.combinators_source.Epsilon))?cljs.core.remove.call(null,cljs.core.PersistentHashSet.fromArray([instaparse.combinators_source.Epsilon], true),parsers):parsers);if(cljs.core.seq.call(null,parsers__$1))
...
*/
instaparse.combinators_source.unhide_all_content = (function unhide_all_content(grammar){return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4379__auto__ = (function iter__32362(s__32363){return (new cljs.core.LazySeq(null,(function (){var s__32363__$1 = s__32363;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__32363__$1);if(temp__4126__auto__)
{var s__32363__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__32363__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__32363__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__32365 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__32364 = (0);while(true){
if((i__32364 < size__4378__auto__))
{var vec__32368 = cljs.core._nth.call(null,c__4377__auto__,i__32364);var k = cljs.core.nth.call(null,vec__32368,(0),null);var v = cljs.core.nth.call(null,vec__32368,(1),null);cljs.core.chunk_append.call(null,b__32365,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content.call(null,v)], null));
{
...
{var vec__32369 = cljs.core.first.call(null,s__32363__$2);var k = cljs.core.nth.call(null,vec__32369,(0),null);var v = cljs.core.nth.call(null,vec__32369,(1),null);return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content.call(null,v)], null),iter__32362.call(null,cljs.core.rest.call(null,s__32363__$2)));
}
} else
{return null;
}
...
return (function iter__32379(s__32380){return (new cljs.core.LazySeq(null,((function (reduction,temp__4124__auto__){
return (function (){var s__32380__$1 = s__32380;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__32380__$1);if(temp__4126__auto__)
{var s__32380__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__32380__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__32380__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__32382 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__32381 = (0);while(true){
if((i__32381 < size__4378__auto__))
{var vec__32385 = cljs.core._nth.call(null,c__4377__auto__,i__32381);var k = cljs.core.nth.call(null,vec__32385,(0),null);var v = cljs.core.nth.call(null,vec__32385,(1),null);cljs.core.chunk_append.call(null,b__32382,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.call(null,v,new cljs.core.Keyword(null,"red","red",-969428204),reduction.call(null,k))], null));
{
...
{var vec__32386 = cljs.core.first.call(null,s__32380__$2);var k = cljs.core.nth.call(null,vec__32386,(0),null);var v = cljs.core.nth.call(null,vec__32386,(1),null);return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.call(null,v,new cljs.core.Keyword(null,"red","red",-969428204),reduction.call(null,k))], null),iter__32379.call(null,cljs.core.rest.call(null,s__32380__$2)));
}
} else
{return null;
}
...
{var reduction = temp__4124__auto__;return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4379__auto__ = ((function (reduction,temp__4124__auto__){
return (function iter__32396(s__32397){return (new cljs.core.LazySeq(null,((function (reduction,temp__4124__auto__){
return (function (){var s__32397__$1 = s__32397;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__32397__$1);if(temp__4126__auto__)
{var s__32397__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__32397__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__32397__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__32399 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__32398 = (0);while(true){
if((i__32398 < size__4378__auto__))
{var vec__32402 = cljs.core._nth.call(null,c__4377__auto__,i__32398);var k = cljs.core.nth.call(null,vec__32402,(0),null);var v = cljs.core.nth.call(null,vec__32402,(1),null);cljs.core.chunk_append.call(null,b__32399,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.call(null,instaparse.combinators_source.unhide_content.call(null,v),new cljs.core.Keyword(null,"red","red",-969428204),reduction.call(null,k))], null));
{
...
{var vec__32403 = cljs.core.first.call(null,s__32397__$2);var k = cljs.core.nth.call(null,vec__32403,(0),null);var v = cljs.core.nth.call(null,vec__32403,(1),null);return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.call(null,instaparse.combinators_source.unhide_content.call(null,v),new cljs.core.Keyword(null,"red","red",-969428204),reduction.call(null,k))], null),iter__32396.call(null,cljs.core.rest.call(null,s__32397__$2)));
}
} else
{return null;
}
...
instaparse.combinators_source.auto_whitespace_parser = (function auto_whitespace_parser(parser,ws_parser){var G__32407 = (((new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser).fqn:null);switch (G__32407) {
case "neg":
...
return (function (p1__32405_SHARP_){return auto_whitespace_parser.call(null,p1__32405_SHARP_,ws_parser);
});})(G__32407))
...
return (function iter__32417(s__32418){return (new cljs.core.LazySeq(null,((function (ws_parser,grammar_ws__$1){
return (function (){var s__32418__$1 = s__32418;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__32418__$1);if(temp__4126__auto__)
{var s__32418__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__32418__$2))
{var c__4377__auto__ = cljs.core.chunk_first.call(null,s__32418__$2);var size__4378__auto__ = cljs.core.count.call(null,c__4377__auto__);var b__32420 = cljs.core.chunk_buffer.call(null,size__4378__auto__);if((function (){var i__32419 = (0);while(true){
if((i__32419 < size__4378__auto__))
{var vec__32423 = cljs.core._nth.call(null,c__4377__auto__,i__32419);var nt = cljs.core.nth.call(null,vec__32423,(0),null);var parser = cljs.core.nth.call(null,vec__32423,(1),null);cljs.core.chunk_append.call(null,b__32420,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser.call(null,parser,ws_parser)], null));
{
...
{var vec__32424 = cljs.core.first.call(null,s__32418__$2);var nt = cljs.core.nth.call(null,vec__32424,(0),null);var parser = cljs.core.nth.call(null,vec__32424,(1),null);return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser.call(null,parser,ws_parser)], null),iter__32417.call(null,cljs.core.rest.call(null,s__32418__$2)));
}
} else
{return null;
}
