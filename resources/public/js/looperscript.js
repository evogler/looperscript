...
document.write("<script>if (typeof goog != \"undefined\") { goog.require(\"figwheel.connect.build_fat\"); }</script>");
document.write('<script>goog.require("cljs.looperscript.looperscript");</script>');