...
{var pred__28613 = cljs.core._EQ_;var expr__28614 = limit;if(cljs.core.truth_(pred__28613.call(null,(1),expr__28614)))
...
{var ch = s.charAt(index);var temp__4124__auto___28620 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___28620))
{var replacement_28621 = temp__4124__auto___28620;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_28621)));
} else
{buffer.append(ch);
}
{
