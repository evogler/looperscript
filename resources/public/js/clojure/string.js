...
{var pred__31774 = cljs.core._EQ_;var expr__31775 = limit;if(cljs.core.truth_(pred__31774.call(null,(1),expr__31775)))
...
{var ch = s.charAt(index);var temp__4124__auto___31781 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___31781))
{var replacement_31782 = temp__4124__auto___31781;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_31782)));
} else
{buffer.append(ch);
}
{
