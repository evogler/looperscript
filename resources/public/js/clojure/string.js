...
{{
var G__13626 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13626;
continue;
}
} else
...
{var pred__13630 = cljs.core._EQ_;var expr__13631 = limit;if(cljs.core.truth_(pred__13630.call(null,(1),expr__13631)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13630.call(null,(2),expr__13631)))
...
var G__13633 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13634 = (limit__$1 - (1));
var G__13635 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__13633;
limit__$1 = G__13634;
parts = G__13635;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13637 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13637))
{var replacement_13638 = temp__4124__auto___13637;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13638)));
} else
{buffer.append(ch);
}
{
var G__13639 = (index + (1));
index = G__13639;
continue;
}
}
